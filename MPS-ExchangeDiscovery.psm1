...
.TODO
    Adjust and automate Output Formats / locations
        ...
        Get-MPSActiveDirectoryReplication working
...
Function Set-MPSOutput{
    ...
    param (
        ...
        [Parameter(Mandatory)]
        [ValidateSet('txt','html')] #todo add 'csv' and add 'md'
        [string]$type
    )
}
Function Set-MPSEnv {
...
Function Get-MPSOutlookConn2007 {
    $filePATH = $global:MPSOutPath 
    $fileNAME = "OutlookConn2007"+ $global:MPSOutPrefix +".txt"
    $file = $filePATH + "\" + $fileNAME 
    echo $null >> $file

        Get-MailboxServer | Get-LogonStatistics | Select UserName,ClientVersion,LastAccessTime,ServerName > $file
