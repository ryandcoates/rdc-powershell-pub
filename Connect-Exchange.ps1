...
.LINK 
    ...
    ScriptPage : https://github.com/ryandcoates/rdc-powershell-pub/blob/master/Connect-o365.ps1
    ScriptRAW  : https://github.com/ryandcoates/rdc-powershell-pub/raw/master/Connect-o365.ps1
#>        
